...
- **Data nyata**: FAQ=0, Reviews=3, Stats=1. Package: 15 (bundling+combo), Service satuan: 12. Kategorisasi layanan di landing oleh `ServiceCategory.type` (satuan/bundling/combo).
