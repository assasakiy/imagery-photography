...
- **Integrasi: badge status jadi tombol accordion (terbaru)**: tombol "Konfigurasi" terpisah dihapus — badge **Terkonfigurasi/Belum Dikonfigurasi** di kartu Email & WhatsApp kini **bisa diklik** (cursor-pointer, chevron) utk membuka/menutup form config. Ringkas, satu kontrol.
