                ...
                <div className="space-y-6">
                    <div className="card w-full p-6">
                        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                            ...
                            <span className={`badge ${statusBadge(meta.email_configured)}`}>
                                {meta.email_configured ? 'Terkonfigurasi' : 'Belum terkonfigurasi'}
                            </span>
                        </div>
                        {meta.env_mail_configured && (
                            <p className="mb-4 rounded-lg bg-sky-500/10 px-3 py-2 text-xs text-sky-600 dark:text-sky-400">
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <Field label="Host" hint="opsional" error={errors.mail_host?.[0]}>
                                <input className="input" placeholder="smtp.gmail.com" value={form.mail_host} onChange={(e) => set('mail_host', e.target.value)} />
                            </Field>
                            <Field label="Port" hint="opsional" error={errors.mail_port?.[0]}>
                    ...
                    <div className="card w-full p-6">
                        <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
                            <div>
                                ...
                                <p className="text-xs text-ink-muted">Pilih driver, isi konfigurasinya, lalu tes koneksi. Menambah provider baru cukup dilakukan di backend tanpa mengubah halaman ini.</p>
                            </div>
                            <span className={`badge ${statusBadge(meta.whatsapp_configured)}`}>
                                {meta.whatsapp_configured ? 'Terhubung' : 'Belum terhubung'}
                            </span>
                        </div>
