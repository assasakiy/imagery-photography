import { Modal, Field, formatDate } from './ui';
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <p className="break-all rounded-xl border border-line bg-surface-muted px-3 py-2 text-sm text-ink">{item.name}</p>
                    </div>
                    <div>
                        <label className="label">Nama File</label>
                        <p className="break-all rounded-xl border border-line bg-surface-muted px-3 py-2 text-sm text-ink-muted">{item.file_name}</p>
                    </div>
                    <div>
                        <label className="label">Tipe</label>
                        <p className="rounded-xl border border-line bg-surface-muted px-3 py-2 text-sm text-ink-muted">{item.mime_type}</p>
                    </div>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="label">Ukuran</label>
                            <p className="rounded-xl border border-line bg-surface-muted px-3 py-2 text-sm text-ink-muted">{formatSize(item.size)}</p>
                        </div>
                        <div>
                            <label className="label">Diunggah</label>
                            <p className="rounded-xl border border-line bg-surface-muted px-3 py-2 text-sm text-ink-muted">{formatDate(item.created_at)}</p>
                        </div>
                    </div>
                </div>
