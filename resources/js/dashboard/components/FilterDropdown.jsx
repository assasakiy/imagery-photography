        ...
        <div className="relative ml-auto w-full md:w-auto">
            <button type="button" onClick={() => setOpen((current) => !current)} className="input flex w-full items-center justify-between gap-2 px-3 text-sm">
                <span className="flex min-w-0 items-center gap-2">
                    ...
                    {selected.length > 0 && <span className="inline-flex h-4 min-w-4 shrink-0 items-center justify-center rounded-full action-surface px-1 text-[9px] font-bold leading-none">{selected.length}</span>}
                </span>
