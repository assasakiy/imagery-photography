...
function OfficialTeamBadge() {
    return (
        <span className="inline-flex h-4 w-4 shrink-0 text-brand-600 dark:text-brand-400" title="Tim Resmi" aria-label="Tim Resmi">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <path d="m8.5 10.8 2.15 2.15 4.85-5" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        </span>
    );
}
