                                        ...
                                        <div className={`max-w-[85%] sm:max-w-[75%] ${isAdmin ? '' : 'flex flex-col items-end'}`}>
                                            <div className="mb-1 flex items-center gap-2 px-1 text-[11px] text-ink-muted">
                                                ...
                                                <span className="inline-flex items-center gap-1.5">
                                                    ...
                                                    {isAdmin && m.user?.roles?.[0]?.name !== 'owner' && m.user?.roles?.[0]?.name !== undefined && (
                                                        ...
                                                        {openMenuId === m.id && (
                                                            <>
                                                                ...
                                                                <div className="absolute left-0 sm:right-0 top-full z-20 mt-1 w-32 rounded-xl border border-line bg-surface p-1.5 shadow-xl">
                                                                    ...
                                                                    <button onClick={() => { setConfirmDeleteId(m.id); setOpenMenuId(null); }} className="flex w-full items-center gap-2 rounded-lg px-2.5 py-2 text-left text-sm text-red-500 hover:bg-red-500/10">
