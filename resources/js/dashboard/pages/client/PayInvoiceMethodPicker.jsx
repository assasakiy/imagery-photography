                            ...
                            return (
                                <div key={idx} className="rounded-xl border border-line p-5">
                                    <h4 className="mb-4 flex items-center gap-2 font-bold text-ink">
                                        <span className="text-brand-500 w-5 h-5 flex items-center justify-center">
                                            {icon}
                                        </span>
                                        {label}
                                    </h4>
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        {(group.accounts || []).map((it, iIdx) => (
                                            ...
                                            >
                                                <p className="font-semibold text-ink">{it.name || it.merchant}</p>
                                                {it.number && (
                                                    <p className="font-mono text-sm text-ink-muted">{it.number}</p>
                                                )}
                                            </button>
                                        ))}
                                    </div>
