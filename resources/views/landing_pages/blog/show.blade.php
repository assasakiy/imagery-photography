            ...
            <div class="mt-5 flex flex-wrap items-center gap-3 text-sm text-ink-muted">
                @if ($author)
                    <a href="{{ route('blog.author', ['username' => $author->username]) }}" class="flex items-center gap-2.5">
                        ...
                        @endif
                        <span class="font-medium text-ink">@include('partials.official-team-name', ['user' => $author, 'name' => $authorName])</span>
                    </a>
                @else
                            ...
                            <div class="p-4">
                                ...
                                <div class="mt-2 flex items-center gap-2">
                                    ...
                                    <span class="inline-flex items-center gap-1 text-xs text-ink-muted">
                                        @if ($item->author)
                                            @include('partials.official-team-name', ['user' => $item->author])
                                        @else
